# DiscussionBridge Human Operator Manual
...
[Platform Profile](./PLATFORM_PROFILES.md), and the
[Adapter Operating Models](./ADAPTER_OPERATING_MODELS.md). Do not copy commands
...
[Versions And Live Status](./VERSIONS_AND_LIVE_STATUS.md) and the component's
...
material. Follow [Key Management](./KEY_MANAGEMENT.md).
