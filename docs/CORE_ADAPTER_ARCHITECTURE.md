# DiscussionBridge Product And Adapter Architecture
...
See [Presentation Modes](./PRESENTATION_MODES.md).
...
Adapter Protocol. See [Attribution, Ownership, And Licensing](./ATTRIBUTION_OWNERSHIP_LICENSE.md)
and [Adapter Operating Models](./ADAPTER_OPERATING_MODELS.md).
