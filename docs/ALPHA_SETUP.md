...
1. [Alpha Installation and Operator Guide](./ALPHA_OPERATOR_GUIDE.md) for the
   end-to-end installation and acceptance sequence.
2. [Platform Profiles](./PLATFORM_PROFILES.md) for platform-specific package and
   runtime requirements.
3. [Adapter Operating Models](./ADAPTER_OPERATING_MODELS.md) for native objects,
   claim limits, leases, worker cadence, acknowledgement, and recovery.
4. [Presentation Modes](./PRESENTATION_MODES.md) for Simple, Full, and
   Interactive presentation.
5. [Key Management](./KEY_MANAGEMENT.md) for connection secrets and other
   protected credentials.
6. [Troubleshooting](./TROUBLESHOOTING.md) for current queue and adapter triage.
