# Product Build And Launch Checklists
...
[Versions And Live Status](./VERSIONS_AND_LIVE_STATUS.md). Operating behavior is
defined in [Adapter Operating Models](./ADAPTER_OPERATING_MODELS.md).
