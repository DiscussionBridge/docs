...
const docs = [
  ...
  "ASTRO_INSTALL_OPERATE.md",
  "GHOST_INSTALL_OPERATE.md",
  "HUGO_INSTALL_OPERATE.md",
  "STATAMIC_INSTALL_OPERATE.md",
  "WORDPRESS_INSTALL_OPERATE.md",
  "CHANGE_PLATFORMS_KEEP_DISCUSSION.md",
